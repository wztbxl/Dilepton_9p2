...
void bookHistograms()
{
	...
	hNHitsFitvsPtQ = new TH3F("hNHitsFitvsPtQ","hNHitsFitvsPtQ;q;p_{T} (GeV/c);nHitsFit",2,-1,1,500,0,10,80,0,80);
	hNHitsFitvsEtaQ = new TH3F("hNHitsFitvsEtaQ","hNHitsFitvsEtaQ;q;#eta;nHitsFit",2,-1,1,200,-2,2,80,0,80);
	hNHitsFitvsPhiQ = new TH3F("hNHitsFitvsPhiQ","hNHitsFitvsPhiQ;q;#phi;nHitsFit",2,-1,1,360,-TMath::Pi(),TMath::Pi(),80,0,80);
	hNHitsPossvsPtQ = new TH3F("hNHitsPossvsPtQ","hNHitsPossvsPtQ;q;p_{T} (GeV/c);nHitsPoss",2,-1,1,500,0,10,80,0,80);
	hNHitsPossvsEtaQ = new TH3F("hNHitsPossvsEtaQ","hNHitsPossvsEtaQ;q;#eta;nHitsPoss",2,-1,1,200,-2,2,80,0,80);
	hNHitsPossvsPhiQ = new TH3F("hNHitsPossvsPhiQ","hNHitsPossvsPhiQ;q;#phi;nHitsPoss",2,-1,1,360,-TMath::Pi(),TMath::Pi(),80,0,80);
	hNHitsDedxvsPtQ = new TH3F("hNHitsDedxvsPtQ","hNHitsDedxvsPtQ;q;p_{T} (GeV/c);nHitsDedx",2,-1,1,500,0,10,80,0,80);
	...
	hPiNHitsFitvsPtQ = new TH3F("hPiNHitsFitvsPtQ","hPiNHitsFitvsPtQ;q;p_{T} (GeV/c);nHitsFit",2,-1,1,500,0,10,80,0,80);
	hPiNHitsFitvsEtaQ = new TH3F("hPiNHitsFitvsEtaQ","hPiNHitsFitvsEtaQ;q;#eta;nHitsFit",2,-1,1,200,-2,2,80,0,80);
	hPiNHitsFitvsPhiQ = new TH3F("hPiNHitsFitvsPhiQ","hPiNHitsFitvsPhiQ;q;#phi;nHitsFit",2,-1,1,360,-TMath::Pi(),TMath::Pi(),80,0,80);
	hPiNHitsPossvsPtQ = new TH3F("hPiNHitsPossvsPtQ","hPiNHitsPossvsPtQ;q;p_{T} (GeV/c);nHitsPoss",2,-1,1,500,0,10,80,0,80);
	hPiNHitsPossvsEtaQ = new TH3F("hPiNHitsPossvsEtaQ","hPiNHitsPossvsEtaQ;q;#eta;nHitsPoss",2,-1,1,200,-2,2,80,0,80);
	hPiNHitsPossvsPhiQ = new TH3F("hPiNHitsPossvsPhiQ","hPiNHitsPossvsPhiQ;q;#phi;nHitsPoss",2,-1,1,360,-TMath::Pi(),TMath::Pi(),80,0,80);
	hPiNHitsDedxvsPtQ = new TH3F("hPiNHitsDedxvsPtQ","hPiNHitsDedxvsPtQ;q;p_{T} (GeV/c);nHitsDedx",2,-1,1,500,0,10,80,0,80);
