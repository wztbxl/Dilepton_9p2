...
bool debug = false;
const char *myDir = "/star/u/liuzhen/Run15/Run15pp200/submitjob/Polarization/toyMcSys/HXFrame";
...
int testData( const int nExpr=1e5, double LamThe= 0.5, double LamPhi= 0.5, double LamThePhi=0, int nLoop=1, int iter=0)
{
    ...
    double lamTheArray[nthetaphi] = {-0.021, -0.331, -0.169, 0.117};
    double lamPhiArray[nthetaphi] = {-0.059, 0.125, 0.254, -0.012};
    ...
    for(int i=0; i<nExpr; i++)
    {
        ...
        calPolarizationHX(daughter1, parent, inLamThe[pt_index], inLamPhi[pt_index], LamThePhi, fPolar, true, 0, iter);
        ...
        calPolarizationHX(daughter1, parent, inLamThe[pt_index], inLamPhi[pt_index], LamThePhi, fPolar, true, 1, iter);
    }
    char *outName;
