...
int ana_data5(double dca=varDca[0], double nHitsFit=varNhitsFit[0], double nHitsDedx=varNhitsDedx[0], double nSigmaPi=varNsigmaPi[1])
{
    ...
    //drawHistrom(buf,2,4,1,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,4,2,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,4,3,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,4,4,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //// pol2 & free //
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,2,1,0,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,2,2,0,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,2,3,0,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,2,4,0,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //
    //// *** pol 3 & rebin2 *** //
    //// fix //
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,3,0,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //// free //
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,2,3,0,0,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //
    //// *** shift & rebin4 *** //
    //// fix //
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,4,3,1,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,4,3,2,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,4,3,3,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    //get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    //drawHistrom(buf,4,3,4,1,1); //rebin & nPol & sLR & fix & savePDF
    //closeFile();
    // free //
    get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    drawHistrom(buf,4,3,1,0,1); //rebin & nPol & sLR & fix & savePDF
    closeFile();
    get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    drawHistrom(buf,4,3,2,0,1); //rebin & nPol & sLR & fix & savePDF
    closeFile();
    get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    drawHistrom(buf,4,3,3,0,1); //rebin & nPol & sLR & fix & savePDF
    closeFile();
    get_Angular_Histo(dca, nHitsFit, nHitsDedx, nSigmaPi);
    drawHistrom(buf,4,3,4,0,1); //rebin & nPol & sLR & fix & savePDF
    closeFile();
