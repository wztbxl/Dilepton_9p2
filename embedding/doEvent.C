...
void doEvent(const Int_t nEvents = 2000,
			 const char *fMcFile = "/star/data105/embedding/production_7p7GeV_2021/Electron_100_20224105/P22ib.SL22b/2021/056/22056005/st_physics_adc_22056005_raw_0000000.MuDst.root",
			 ...
			 const Char_t *outDir = "./test")
{
	...
	int embedRunIndex = embedrun.Index("production_7p7GeV_2021", 0);
